...
export default function AcademyLogin() {
  ...
  async function handleGoogle() {
    ...
    await supabase.auth.signInWithOAuth({
      provider: "google",
      options: { redirectTo: `${window.location.origin}/academy/dashboard` },
    });
  }
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="bg-white/[0.06] backdrop-blur-xl rounded-3xl border border-white/10 p-7 shadow-2xl shadow-black/40">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 rounded-2xl border border-white/15 bg-white/[0.06] hover:bg-white/[0.10] disabled:opacity-50 py-3 px-4 text-sm font-semibold text-white transition mb-4"
            >
              {googleLoading ? (
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[11px] text-white/30 font-medium">or use email</span>
              <div className="flex-1 h-px bg-white/[0.08]" />
            </div>
