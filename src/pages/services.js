          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
              ...
              <p className="text-slate-300 text-sm">
                Custom software to automate workflows, reduce manual effort, and
                improve reliability.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
              ...
              <p className="text-slate-300 text-sm">
                Mobile apps built for speed, usability, and real business
                outcomes (including your School Bus App).
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
              ...
              <p className="text-slate-300 text-sm">
                Modern, responsive websites that look premium and convert
                visitors into leads.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
              ...
              <p className="text-slate-300 text-sm">
                Secure, stable networks with clean setup, monitoring guidance,
                and best practices.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
              ...
              <p className="text-slate-300 text-sm">
                Smooth installations, upgrades, and troubleshooting for office
                and small enterprise setups.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
              ...
              <p className="text-slate-300 text-sm">
                Basic hardening, access control, backups, and security checks to
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4 md:col-span-2">
              ...
              <p className="text-slate-300 text-sm">
                Product explainers, promos, and business videos that support
